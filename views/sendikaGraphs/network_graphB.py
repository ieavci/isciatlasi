...
# "Türk İş" düğümünü ekleyelim
net.add_node('Türk İş', label='Türk İş', color='orange')

# Sendikaları "Türk İş" düğümüne bağlayalım
for union in unions:
    net.add_edge('Türk İş', union, title='alt sendika')
...
with open('network_graphB.html', 'w', encoding='utf-8') as f:
